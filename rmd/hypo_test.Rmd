...
The transformed data is used for the following analysis.
...
The result table shows a p-value of 0, which is sufficiently small to reject the null. Thus, we conclude that at least one age group has a mean wealth differing from the rest age groups. 
...
dt <- bil_age |> 
  group_by(age_group) |> 
  summarize(pos = max(net_worth_t) + 0.08) |>  
