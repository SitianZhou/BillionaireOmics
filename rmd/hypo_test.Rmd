...
## Paired t-test: compare wealth of billionaires between 2013 and 2023
...
```{r anova results}
summary(model_t) |> broom::glance() |> knitr::kable()
```
...
TukeyHSD(res) |> broom::tidy() |> knitr::kable()
...
## Other tests (not informative or w/ independence issue)
